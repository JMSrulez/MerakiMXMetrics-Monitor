...
A valid Meraki API key (how to generate a Meraki API key)
...
```bash
   ...
   ```
Create a `meraki_api_key.txt` file in the same folder as the script, containing only your Meraki API key:
```
